...
public class RailProtectionManager implements Listener {
    ...
    public static final class ProtectionIndexStats {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof ProtectionIndexStats)) return false;
            ProtectionIndexStats that = (ProtectionIndexStats) o;
            return sampledPoints == that.sampledPoints
                    && indexedBlocks == that.indexedBlocks
                    && skippedWorldMismatch == that.skippedWorldMismatch
                    && skippedMissingWorld == that.skippedMissingWorld
                    && skippedNoRail == that.skippedNoRail;
        }

        @Override
        public int hashCode() {
            int result = sampledPoints;
            result = 31 * result + indexedBlocks;
            result = 31 * result + skippedWorldMismatch;
            result = 31 * result + skippedMissingWorld;
            result = 31 * result + skippedNoRail;
            return result;
        }
    }
